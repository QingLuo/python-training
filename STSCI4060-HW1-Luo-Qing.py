print '''\nSTSCI 4060 HW1
Programmer Name: Qing Luo
'''

print '\n******Question1******\n'
excerpt = '''The Old Sea-dog at the Admiral Benbow
...
print '\n******Question3******\n'
words  = set(excerpt.split())

print '\n******Question4******\n'
len(words)

print '\n******Question5******\n'
num_lines = sum(1 for line in open('TIexcerpt1.txt'))
num_lines

print '\n******Question6******\n'
sentences = excerpt.count(".")+excerpt.count("?")+excerpt.count("!")-excerpt.count("Dr.")
sentences